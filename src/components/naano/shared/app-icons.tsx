...
export function LinkedInIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" width={20} height={20} aria-hidden {...props}>
      ...
      <path
        fill="#fff"
        d="M7.2 9.6H4.7V19h2.5V9.6ZM5.95 8.5a1.45 1.45 0 1 0 0-2.9 1.45 1.45 0 0 0 0 2.9ZM19.3 19h-2.5v-4.9c0-1.17-.42-1.97-1.47-1.97-.8 0-1.28.54-1.49 1.06-.08.19-.1.45-.1.71V19H11.2s.03-8.5 0-9.4h2.55v1.33c.34-.52.94-1.26 2.29-1.26 1.67 0 2.92 1.09 2.92 3.44V19Z"
      />
    </svg>
  );
}
...
export function GoogleIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" width={20} height={20} aria-hidden {...props}>
      <path fill="#4285F4" d="M23.5 12.3c0-.8-.07-1.57-.2-2.3H12v4.35h6.46a5.52 5.52 0 0 1-2.4 3.62v3h3.88c2.27-2.09 3.56-5.17 3.56-8.67Z" />
      ...
      <path fill="#EA4335" d="M12 4.75c1.77 0 3.35.61 4.6 1.8l3.44-3.44A11.98 11.98 0 0 0 12 0 12 12 0 0 0 1.28 6.61l4.01 3.11C6.23 6.86 8.88 4.75 12 4.75Z" />
    </svg>
  );
}
